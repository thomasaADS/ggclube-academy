...
export const metadata: Metadata = { title: "Preflop Mastery — שליטה ב-Preflop", description: "קורס מתקדם לבניית אסטרטגיית Preflop מושלמת." };

const LESSONS = [
  { title: "למה Preflop הוא הבסיס לכל השאר", duration: "15 דק׳", free: true },
  { title: "ריינג׳ים לפי פוזיציה — Open Raise", duration: "28 דק׳", free: true },
  { title: "3-Bet Ranges — מתי ואיך להעלות", duration: "25 דק׳", free: false },
  { title: "Defending vs 3-Bet — Call, 4-Bet או Fold", duration: "30 דק׳", free: false },
  { title: "Squeeze Play — לנצל פוזיציה נגד מספר שחקנים", duration: "22 דק׳", free: false },
  { title: "SB vs BB — הקרב האינסופי", duration: "25 דק׳", free: false },
  { title: "Limp Pots — איך לנצל לימפרים", duration: "18 דק׳", free: false },
  { title: "בניית ריינג׳ מותאם ליריבים", duration: "28 דק׳", free: false },
];

export default function PreflopCoursePage() {
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="grid lg:grid-cols-5 gap-8">
        <div className="lg:col-span-3">
          ...
          <h1 className="text-3xl font-black text-t-50 mt-3 mb-3">Preflop Mastery — שליטה ב-Preflop</h1>
          <p className="text-t-300 leading-relaxed">Preflop הוא היסוד של כל יד. טעויות כאן עולות ביוקר. בקורס הזה תבנו ריינג׳ים מדויקים לכל פוזיציה, תלמדו 3-Bet, 4-Bet, Squeeze ואסטרטגיית SB vs BB מתקדמת.</p>
          ...
          <div className="flex gap-6 mt-5 text-sm text-t-400">
            ...
            <span className="flex items-center gap-1"><Clock className="w-4 h-4 text-red-400" />3+ שעות</span>
          ...
          <ul className="grid sm:grid-cols-2 gap-2">
            {["ריינג׳ים מדויקים לכל פוזיציה", "מתי ואיך לעשות 3-Bet", "להגן נכון נגד 3-Bet", "Squeeze Play מתקדם", "אסטרטגיית SB vs BB", "לבנות ריינג׳ מותאם ליריבים"].map(x => (
        ...
        <div className="lg:col-span-2">
          <div className="sticky top-20 p-6 rounded-xl bg-bg-card border border-line">
            <div className="aspect-video rounded-lg overflow-hidden mb-4">
              <img src="/courses/cards2.jpg" alt="Preflop Mastery" className="w-full h-full object-cover" />
            </div>
