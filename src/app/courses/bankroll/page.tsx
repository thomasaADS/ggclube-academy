...
export const metadata: Metadata = { title: "ניהול באנקרול — לשחק בלי לפשוט רגל", description: "קורס מקיף לניהול כספי חכם בפוקר." };

const LESSONS = [
  { title: "מה זה באנקרול ולמה זה קריטי", duration: "15 דק׳", free: true },
  { title: "כללי באנקרול לפי פורמט — קאש, MTT, SNG", duration: "22 דק׳", free: true },
  { title: "Moving Up — מתי לעלות בסטייקס", duration: "20 דק׳", free: false },
  { title: "Moving Down — מתי לרדת (ולמה זה בסדר)", duration: "18 דק׳", free: false },
  { title: "וריאנס — להבין את התנודות", duration: "25 דק׳", free: false },
  { title: "הפרדה בין כסף משחק לכסף חיים", duration: "15 דק׳", free: false },
  { title: "תכנון פיננסי לשחקן מקצועי", duration: "28 דק׳", free: false },
];

export default function BankrollCoursePage() {
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="grid lg:grid-cols-5 gap-8">
        <div className="lg:col-span-3">
          ...
          <h1 className="text-3xl font-black text-t-50 mt-3 mb-3">ניהול באנקרול — לשחק בלי לפשוט רגל</h1>
          <p className="text-t-300 leading-relaxed">שחקנים רבים מפסידים לא בגלל המשחק אלא בגלל ניהול כספי גרוע. בקורס הזה תלמדו כמה באנקרול צריך לכל פורמט, מתי לעלות ולרדת בסטייקס, ואיך לתכנן פיננסית כשחקן פוקר.</p>
          ...
          <ul className="grid sm:grid-cols-2 gap-2">
            {["כמה באנקרול צריך לכל פורמט", "כללים ברורים לעלייה וירידה בסטייקס", "להבין וריאנס ולא להיבהל מתנודות", "להפריד כסף משחק מכסף חיים", "תכנון פיננסי לטווח ארוך", "לבנות באנקרול בצורה יציבה ובטוחה"].map(x => (
        ...
        <div className="lg:col-span-2">
          <div className="sticky top-20 p-6 rounded-xl bg-bg-card border border-line">
            <div className="aspect-video rounded-lg overflow-hidden mb-4">
              <img src="/courses/chips2.jpg" alt="ניהול באנקרול" className="w-full h-full object-cover" />
            </div>
